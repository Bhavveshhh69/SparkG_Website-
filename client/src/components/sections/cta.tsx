...
export default function CTA() {
  ...
  return (
    <section className="py-16 sm:py-20 bg-gradient-to-br from-sparkg-black via-gray-900 to-sparkg-dark relative overflow-hidden">
      {/* Animated Background Elements */}
      <div className="absolute inset-0">
        <div className="absolute top-10 left-10 w-24 h-24 sm:w-32 sm:h-32 bg-sparkg-gold/10 rounded-full blur-xl animate-pulse"></div>
        <div className="absolute bottom-10 right-10 w-32 h-32 sm:w-48 sm:h-48 bg-blue-500/10 rounded-full blur-2xl animate-bounce"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-72 h-72 sm:w-96 sm:h-96 bg-gradient-to-r from-sparkg-gold/5 to-purple-500/5 rounded-full blur-3xl animate-spin"></div>
      </div>

      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center animate-slideUp">
          <div className="flex justify-center mb-4 sm:mb-6">
            <div className="p-3 sm:p-4 bg-gradient-to-r from-sparkg-gold to-yellow-500 rounded-full">
          ...
          <p className="text-lg sm:text-xl text-gray-200 mb-8 sm:mb-10 max-w-2xl mx-auto leading-relaxed px-4 sm:px-0">
          ...
          <div className="mt-6 sm:mt-8 text-center">
            <p className="text-[#9B7B0B] font-semibold text-sm sm:text-base">⚡ Limited availability for August onboarding</p>
          </div>
        </div>
      </div>
    </section>
