      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <h3 className="text-3xl text-klowt-gray">
            <em className="text-klowt-pink not-italic">DIY</em> your personal brand growth with our most-loved tools.
          </h3>
        </div>

        <div className="grid lg:grid-cols-3 gap-8">
          {resources.map((resource, index) => (
            <div key={index} className="bg-klowt-blue/30 rounded-2xl overflow-hidden group hover:transform hover:scale-105 transition-all duration-300">
              ...
              <div className="p-6">
                ...
                <Button 
                  ...
                  className={`w-full ${resource.buttonVariant === 'default' ? 'bg-klowt-pink hover:bg-klowt-pink/90' : 'border-white/30 text-white hover:bg-white/10'}`}
                >
                  {resource.buttonText}
                </Button>
              </div>
        ...
        <div className="text-center mt-12">
          <Link href="/resources">
            <button className="text-klowt-pink font-medium text-lg hover:underline">
              VIEW ALL RESOURCES →
            </button>
          </Link>
        </div>
