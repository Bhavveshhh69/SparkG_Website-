...
export default function Newsletter() {
  ...
  return (
    <section className="py-16 sm:py-20 bg-gradient-to-r from-sparkg-black via-sparkg-dark to-sparkg-black relative overflow-hidden">
      <div className="absolute inset-0">
        <div className="absolute top-0 left-1/3 w-72 h-72 sm:w-96 sm:h-96 bg-[#9B7B0B]/10 rounded-full blur-3xl animate-pulse"></div>
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="bg-gradient-to-r from-[#9B7B0B]/10 via-[#9B7B0B]/5 to-[#9B7B0B]/10 backdrop-blur-sm rounded-3xl p-6 sm:p-8 md:p-12 text-center border border-[#9B7B0B]/20">
          ...
          <form onSubmit={handleSubmit} className="max-w-2xl mx-auto">
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 animate-slideUp">
              <Input
                ...
                className="flex-1 bg-white/10 backdrop-blur-sm border-white/20 text-white placeholder-gray-400 focus:border-[#9B7B0B]/50 focus:ring-[#9B7B0B]/25 rounded-lg h-11 sm:h-12 text-sm sm:text-base"
              ...
              <Button
                type="submit"
                size="lg"
                className="bg-[#9B7B0B] hover:bg-[#9B7B0B]/90 text-white font-bold transform hover:scale-105 transition-all duration-300 rounded-lg h-11 sm:h-12 px-6 sm:px-8 shadow-2xl hover:shadow-[#9B7B0B]/25 border-2 border-[#9B7B0B] text-xs sm:text-sm md:text-base whitespace-nowrap"
                disabled={newsletterMutation.isPending}
              >
            ...
            <div className="mt-4 sm:mt-6 text-xs sm:text-sm text-gray-400 animate-fadeIn">
